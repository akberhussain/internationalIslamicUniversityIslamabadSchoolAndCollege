...
class HistoryAndGeography extends Component{
	render(){
			  ...
			  <div className="about-section">
				<div className="container">
				     <div className="about-head">
						<h3>Our Courses</h3>
						<h4>Courses/History And Geography</h4>
					 </div>
				</div> 
			  </div>
			  	<div className ="container">
        <div className = "row">
            <div className ="col-md-12">
                <div className= "thumbnail">
                    <img className= "img-responsive" src = "myimages/courses/HG.jpg" />
                    <div className = "caption-full" >
                        
                        <h4 className = "forPadding"><strong>Created By: IIUIS, Latifabad</strong></h4>
                        <h4 className = "forPadding"><a>History And Geography</a></h4>
